	...
	abstract class richpostslistandgridLib extends WP_Widget {
		...
		*/
		...
		public function __construct() {  
			...
			parent::__construct( 'richpostslistandgrid',  __( 'Rich Posts List & Grid View', 'richpostslistandgrid' ) ); 	
		 ...
		 */
		  public function getPostImage(  $img, $width = "180", $height = "180") {
			...
			if( $image_link ) {				
				...
				$_defa_media_image = $this->_config["rplg_media"]["media_url"]."images/no-img.png";
